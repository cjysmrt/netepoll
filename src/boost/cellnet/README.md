...
[1]: https://godoc.org/boost/cellnet?status.svg
[2]: https://godoc.org/boost/cellnet
[3]: https://travis-ci.org/davyxu/cellnet.svg?branch=v3
[4]: https://travis-ci.org/davyxu/cellnet
[5]: https://goreportcard.com/badge/boost/cellnet
[6]: https://goreportcard.com/report/boost/cellnet
...
命令行: go test -v boost/cellnet/benchmark/io
...
* cellnet的私有tcp封包格式是怎样的?
    ...
    封包解析请参考:
    https://boost/cellnet/blob/master/socket/handler_privatepkt.go
...
* 哪里有cellnet的完整例子?
    ...
    https://boost/cellorigin


![Handler全图](doc/handler.png)

# 版本历史
2017.8  v3版本 [详细请查看](https://boost/cellnet/blob/v3/CHANGES.md)

2017.1  v2版本 [详细请查看](https://boost/cellnet/blob/v2/CHANGES.md)
...
提交bug及特性: https://boost/cellnet/issues
